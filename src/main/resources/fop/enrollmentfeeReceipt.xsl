						...
						<fo:table border-collapse="separate" height="17cm"
							...
							<fo:table-body font-family="sans-serif"
								...
								<fo:table-row line-height="20pt">
									...
									<fo:table-cell padding="1mm">
										<fo:block text-align="start">Enrollment Fee Due</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="1mm">
										<fo:block text-align="center">
											$
											<xsl:value-of select="root/enrollmentFeeDue" />
										</fo:block>
									</fo:table-cell>
						...
						<fo:table border-collapse="separate" height="17cm"
							...
							<fo:table-body font-family="sans-serif"
								...
								<fo:table-row line-height="20pt">
									...
									<fo:table-cell padding="1mm">
										<fo:block text-align="start">Enrollment Fee</fo:block>
									</fo:table-cell>
									<fo:table-cell padding="1mm">
										<fo:block text-align="right">
											$
											<xsl:value-of select="root/enrollmentFeeAmount" />
										</fo:block>
									</fo:table-cell>
