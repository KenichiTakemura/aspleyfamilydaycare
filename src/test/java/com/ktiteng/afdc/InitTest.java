...
public class InitTest extends ArquillianUnitTest {
	...
	public void channy() throws IOException {
		...
		rc.issueReceipt(c, ps1);
		//rc.sendReceipt(c, ps1);
		...
		pc.updatePaymentSchedule(c, ps2);
		rc.issueReceipt(c, ps2);
		//rc.sendReceipt(c, ps2);
	}
...
//		Parent p = cc.addParent("Sung Joon", "Hong", "0452506955", "jooninau@gmail.com");
		Parent p = cc.addParent("Sung Joon", "Hong", "0452506955", "ktiteng@yahoo.com");
